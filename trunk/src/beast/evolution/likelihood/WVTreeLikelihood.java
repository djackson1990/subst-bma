...
public class WVTreeLikelihood extends TreeLikelihood{
   ...
   private int[] patternWeights;
    private int[] storedPatternWeights;
    private boolean weightsChanged;
    private double[] storedPatternLogLikelihoods;
...
@Override
    ...
    protected void calcLogP() throws Exception {
        ...
        if (m_bAscertainedSitePatterns) {
	        ...
	        for (int i = 0; i < m_data.get().getPatternCount(); i++) {
                ...
                //System.out.println("m_fPatternLogLikelihoods[i]: "+m_fPatternLogLikelihoods[i]);
                //System.out.println("patternWeights[i]: "+patternWeights[i]);
    ...
    protected boolean requiresRecalculation() {
        ...
        //System.err.println("flag5: "+m_tree.get().somethingIsDirty());
    ...
    public void lessWeight(int patId, int dweight){
        patternWeights[patId] -= dweight;
        //System.out.println("patId: "+patId+", patternWeights[patId]: "+patternWeights[patId]);
        weightsChanged = true;
    }
