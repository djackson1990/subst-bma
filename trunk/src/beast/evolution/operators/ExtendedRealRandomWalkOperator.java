...
import beast.core.parameter.CompoundParameter;
...
public class ExtendedRealRandomWalkOperator extends RealRandomWalkOperator{
    ...
    public Input<CompoundParameter> cpInput =
                new Input<CompoundParameter>("parameter", "the parameter to operate a random walk on.", Input.Validate.REQUIRED);
    ...
    public double proposal() {
        CompoundParameter param = cpInput.get(this);
